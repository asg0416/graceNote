-- Keep unassigned active memberships when rebuilding the current season plan.
-- Moving a person out of a group should keep that person in the season editor
-- as unassigned instead of dropping them from the plan assignment list.
