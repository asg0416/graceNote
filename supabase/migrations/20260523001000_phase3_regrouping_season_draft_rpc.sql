-- Phase 3 regrouping season draft RPCs.
-- These functions create and save future regrouping drafts only. They must not
-- mutate live groups, member_directory, group_members, or memberships.
