...
-- During restore, do not update member_directory.is_active=false before
-- reactivating canonical rows. That fires legacy sync triggers and re-archives
-- the memberships that were just restored.
