-- Carry current-season group/member period adjustments from the season editor
-- into live person-structure rows. The 5-arg regrouping save RPC remains the
-- compatibility entry point, but now reads optional starts_week_date /
-- ends_week_date values from p_groups and p_assignments.
