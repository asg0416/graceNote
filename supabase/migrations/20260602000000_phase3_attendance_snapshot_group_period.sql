-- Align attendance snapshot generation with Phase 3 group active periods.
-- Membership rows are only attendance targets when both the membership period
-- and its group period include the selected week.
