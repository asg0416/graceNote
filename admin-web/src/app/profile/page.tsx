...
import { Loader2, User, Lock, Save, ArrowLeft, Eye, EyeOff } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0d1221] p-4 sm:p-8 lg:p-12">
            <div className="max-w-2xl mx-auto space-y-8">
                ...
                {/* Profile Info Card */}
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden border border-slate-100 dark:border-slate-800">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border-none rounded-xl focus:ring-2 focus:ring-indigo-500 text-sm font-medium transition-all pr-12"
                                    />
                                    <button
                                        type="button"
