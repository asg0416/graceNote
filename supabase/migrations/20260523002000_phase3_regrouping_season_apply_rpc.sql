-- Phase 3 regrouping season apply RPC.
-- Applies a saved season draft to live memberships only when the effective
-- week has arrived. Future drafts remain draft-only and must not mutate live
-- groups/memberships before their effective week.
